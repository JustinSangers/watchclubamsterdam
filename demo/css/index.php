...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content" style="max-width:800px;margin:auto;">
    <a href="#" style="">About<br>
    	<span style="font-size:20px;" > Op watchclubamsterdam.com kun je gemakkelijk alle horloges doorzoeken van verschillende winkels in Amsterdam.
    </span></a>
    <div><img src="images/awco_logo.png" width="250"></div>

    <a href="http://facebook.com/watchclubamsterdam">Contact via Facebook</a>
  </div>
</div>
			...
			<?php 
			 ...
			 ?>
						...
						<a href="<?php echo $product_link; ?>" target="_blank">
							...
							<div class="meta">
								<h3 class="meta__title"><?php echo $product_title; ?><br><?php echo $product_model; ?></h3>

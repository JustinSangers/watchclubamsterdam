...
<!-- end FB SDK -->
	...
	<div class="view">
		...
		<header class="bp-header cf">
			...
			<div class="fb-follow" style="display:block;" data-href="https://www.facebook.com/watchclubamsterdam" data-layout="button" data-size="large" data-show-faces="true"></div> 
		</div></h1>

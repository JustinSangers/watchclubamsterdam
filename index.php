...
<!-- Main view -->
	...
	<!-- AWCO watches // from DB-->
			<?php
				...
				$servername = "themarketingassistant.nl";
				$username = "themarke";
				$password = "theMA15";
				$dbname = "themarke";
			...
			<?php
				...
				$result = mysqli_query($conn,"select * from watchclub_data where date(watchclub_data.timestamp) = (SELECT MAX(date(timestamp)) FROM watchclub_data  ) and store = 'awco'
				");
	...
	<!-- AVW watches // from DB-->
			...
			<?php
				...
				$result = mysqli_query($conn,"select * from watchclub_data where date(watchclub_data.timestamp) = (SELECT MAX(date(timestamp)) FROM watchclub_data ) and store = 'avw'
				");
	...
	<!-- end AVW watches // from DB -->

	<!-- Spiegel watches // from DB-->
			<?php
				// connect to database
			...
			<?php
				...
				$result = mysqli_query($conn,"select * from watchclub_data where date(watchclub_data.timestamp) = (SELECT MAX(date(timestamp)) FROM watchclub_data ) and store = 'Spiegel'
				");
